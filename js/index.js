...
const menuClose = document.querySelector('.main-section__header-menu__burger')
menuClose.addEventListener('click', function () {
  mainSection.classList.remove('main-section-open')
  right.classList.remove('right-close')
})
/*  === кнопка обратная связь === */
const feedbackOpen = document.querySelector('.contact-menu__profile')
...
const feedbackClose = document.querySelector('.feedback-headere__close')
...
const callOpen = document.querySelector('.contact-menu__call')
...
const callClose = document.querySelector('.call-headere__close')
...
/* === кнопка читать далее === */
const readOpen = document.querySelector('.content-body__alltext-buttone')
const contentText = document.querySelector('.content-body__text')
const сontentBodyAlltext = document.querySelector('.сontent-body__alltext')
...
const readClose = document.querySelector('.сontent-body__close')
